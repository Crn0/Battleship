import type { GetReturnType } from "../../types/index.ts";
import { createShip, type IShip } from "../ship/ship.ts";
import { validPosition } from "../lib/index.ts";
import { createBoard, ensureRow } from "./utils/index.ts";
